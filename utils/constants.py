...
LOGGING_LV_DEBUG_SONAR = 15
LOGGING_LV_DEBUG_SONAR_NAME = "DEBUG_SONAR"
...
DIAMONDS_NOT_OVERLAPPING = {
    LV_DUTY: [LV_DECEPTION, LV_POSITIVITY, LV_SOCIALITY],
    LV_INTELLECT: [LV_DECEPTION, LV_NEGATIVITY, LV_ADVERSITY],
    LV_ADVERSITY: [LV_MATING, LV_DECEPTION, LV_INTELLECT, LV_SOCIALITY],
    LV_MATING: [LV_POSITIVITY, LV_NEGATIVITY, LV_ADVERSITY, LV_SOCIALITY],
    LV_POSITIVITY: [LV_MATING, LV_DECEPTION, LV_NEGATIVITY, LV_DUTY],
    LV_NEGATIVITY: [LV_MATING, LV_POSITIVITY, LV_INTELLECT],
    LV_DECEPTION: [LV_POSITIVITY, LV_INTELLECT, LV_ADVERSITY, LV_DUTY],
    LV_SOCIALITY: [LV_MATING, LV_ADVERSITY, LV_DUTY]
}
...
BDI_CORE_NAME = "sonar_bdicore"
BDI_CORE_JID = "sonar_bdicore@localhost"
BDI_CORE_PWD = "sonar_bdicore"
CHATTER_NAME = "sonar_chatter"
CHATTER_JID = "sonar_chatter@localhost"
CHATTER_PWD = "sonar_chatter"
DATA_COLLECTOR_NAME = "sonar_data_collector"
DATA_COLLECTOR_JID = "sonar_data_collector@localhost"
DATA_COLLECTOR_PWD = "sonar_data_collector"
SYSTEM_HANDLER_NAME = "sonar_system_handler"
SYSTEM_HANDLER_JID = "sonar_system_handler@localhost"
SYSTEM_HANDLER_PWD = "sonar_system_handler"
POSITION_HANDLER_NAME = "sonar_position_handler"
POSITION_HANDLER_JID = "sonar_position_handler@localhost"
POSITION_HANDLER_PWD = "sonar_position_handler"
VISION_HANDLER_NAME = "sonar_vision_handler"
VISION_HANDLER_JID = "sonar_vision_handler@localhost"
VISION_HANDLER_PWD = "sonar_vision_handler"
POSTURE_HANDLER_NAME = "sonar_posture_handler"
POSTURE_HANDLER_JID = "sonar_posture_handler@localhost"
POSTURE_HANDLER_PWD = "sonar_posture_handler"
NORM_ADAPTER_NAME = "sonar_norm_adapter"
NORM_ADAPTER_JID = "sonar_norm_adapter@localhost"
NORM_ADAPTER_PWD = "sonar_norm_adapter"
