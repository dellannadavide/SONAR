...
class FuzzySocialQualifier:
    ...
    Every worker agent can create an internal instance of a fuzzy social qualifier for its own task-specifics
    E.g., the chatter agent might need a fuzzy social qualifier to determine appropriate volume of voice based on
    the current social interpretation. """
